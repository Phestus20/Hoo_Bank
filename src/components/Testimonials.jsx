...
const Testimonials = () => {
  return (
   ...
   ${styles.flexCenter} flex-col relative`}>
    ...
    items-center sm:flex-row flex-col sm:mb-16 mb-6
    relative z-[1] " >
      ...
      <h1 className={styles.heading2}>
        ...
        <div className="w-full md:mt-0 mt-6">
          ...
          max-w-[450px]`}>Everything you need
           to accept card payments and grow your business 
          anywhere on the planet.</p>
        </div>
    </div>

    <div className="flex flex-wrap sm:justify-start 
    justfy-center w-full feedback-container ralative
    z-[1]">
      {feedback.map((card)=>(
