...
/>
         ...
         <h1 className=" font-poppins w-full
      ...
      <div className={/*for the gradient to appear only 
      behind the arm we add a class to this div*/
      `flex-1 flex ${styles.flexCenter}
      md:my-0 my-10 relative`}>
        <img src={robot} alt="billing" className='w-[100%]
        h-[100%] relative z-[5]' />

        {/*adding our gradient behind the image */}
      ...
      {/* for get started to display on mobile*/}
